                ...
                <form action="{{ route('nilai.update', $nilai) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="mahasiswa_id" class="form-control">
                            ...
                            <option value="{{ $mhs->id }}" {{ old('mahasiswa_id', $nilai->mahasiswa_id) == $mhs->id
                                ? 'selected' : '' }}>
                                {{ $mhs->nim }} - {{ $mhs->nama }}
                            </option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select name="kode_mk" id="selectMkEdit" class="form-control">
                            ...
                            <option value="{{ $mk['kode'] }}" data-nama="{{ $mk['nama'] }}" data-sks="{{ $mk['sks'] }}" {{ old('kode_mk', $nilai->kode_mk) == $mk['kode']
                                    ? 'selected' : '' }}>
                    ...
                    <input type="hidden" name="sks" id="hiddenSksEdit" value="{{ old('sks', $nilai->sks) }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="previewSksEdit" value="{{ $nilai->sks }} SKS"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="tahun_akademik"
                                value="{{ old('tahun_akademik', $nilai->tahun_akademik) }}" class="form-control"
                                min="2000" max="{{ date('Y') }}">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('mahasiswa.show', $nilai->mahasiswa) }}" class="btn btn-secondary">
