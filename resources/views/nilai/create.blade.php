                ...
                <form action="{{ route('nilai.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="mahasiswa_id"
                            ...
                            <option value="{{ $mhs->id }}" {{ old('mahasiswa_id', $selectedMahasiswa->id ?? '') == $mhs->id
                                ? 'selected' : '' }}>
                                {{ $mhs->nim }} - {{ $mhs->nama }}
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="previewSks" class="form-control text-center"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="tahun_akademik" value="{{ old('tahun_akademik', date('Y')) }}"
                                class="form-control {{ $errors->has('tahun_akademik') ? 'is-invalid' : '' }}" min="2000"
                                max="{{ date('Y') }}">
